...
export function Sidebar() {
  ...
  return (
    <>
      {/* Mobile top bar: the sidebar folds away below md and opens as a drawer. */}
      <div className="md:hidden fixed top-0 inset-x-0 z-50 h-12 bg-white border-b border-gray-200 flex items-center gap-3 px-3">
        <button
    ...
    <aside
      className={`flex flex-col w-52 bg-white border-r border-gray-200 overflow-y-auto z-50
